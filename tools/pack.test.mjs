...
assert.ok(!listing.includes('.DS_Store'), 'zip should not include macOS metadata');
assert.ok(!listing.includes('.cursor/'), 'zip should not include editor configuration');
